        ...
        <div class="col-md-10">
            <div class="card">
                  <div class="card-header">Tambah Materi</div>
                      <div class="card-body">
                        <form action="/ujian/update/{{$ujian->id}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                    <label class="col-md-2 col-form-label text-md-right">Soal</label>
                                    <div class="col-md-6">
                                      <input type="text" name="soal" value="{{$ujian->soal}}" class="form-control" placeholder="Masukkan Soal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                  <input type="text" name="a" class="form-control" value="{{$ujian->a}}" placeholder="Masukkan Jawaban A">
                                  <div class="text-danger">
                                      @error('a')
                                          {{$message}}
                                      @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                  <input type="text" name="b" class="form-control" value="{{$ujian->b}}" placeholder="Masukkan Jawaban B">
                                  <div class="text-danger">
                                      @error('b')
                                          {{$message}}
                                      @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                  <input type="text" name="c" class="form-control" value="{{$ujian->c}}" placeholder="Masukkan Jawaban C">
                                  <div class="text-danger">
                                      @error('c')
                                          {{$message}}
                                      @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                  <input type="text" name="d" class="form-control" value="{{$ujian->d}}" placeholder="Masukkan Jawaban D">
                                  <div class="text-danger">
                                      @error('d')
                                          {{$message}}
                                      @enderror
