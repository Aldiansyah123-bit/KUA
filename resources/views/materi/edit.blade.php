                      ...
                      <div class="card-body">
                        <form action="/materi/update/{{$materi->id}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                      <input type="text" name="nama_materi" class="form-control" value="{{$materi->nama_materi}}" placeholder="Nama Materi">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                  <textarea rows="10" name="deskripsi" class="form-control" placeholder="Materi">{{$materi->deskripsi}}</textarea>
                                  <div class="text-danger">
                                      @error('deskripsi')
                                          {{$message}}
                                      @enderror
